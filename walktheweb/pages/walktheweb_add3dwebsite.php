...
?>
	<div class="wrap">
	<h2><img src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/menuwtw.png" class="walktheweb_logo" \><?php _e( 'Add 3D Website', 'walktheweb' ); ?></h2>
...
<!--				<img src='/content/system/images/wtwlogo.png' /> -->
				<div id="wtw_selectwebform">
					...
					<div class='walktheweb_clear' style='min-height:20px;'></div>
					<hr />
					<div id='walktheweb_commsearchresults' style='margin-left:20px;text-align:left;'></div>
				</div>
				<div id="walktheweb_installprogress" class="walktheweb_hide walktheweb_iprogresssection">
