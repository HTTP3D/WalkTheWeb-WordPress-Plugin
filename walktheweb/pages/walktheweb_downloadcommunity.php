...
?>
	<form id="walktheweb_form2" method="post" action="?nonce=<?php /* echo $znonce; */ ?>">
		...
		<input id='walktheweb_twebtype' name='walktheweb_twebtype' type='hidden' value='community' />
		<div class="wrap walktheweb_div" style="vertical-align:top;">
			...
			<div class="walktheweb_searchdiv">
				...
				<input name='walktheweb_bsearch' type='button' value='Search' onclick="walktheweb_d.search(document.getElementById('walktheweb_tsearch').value,'community');" class="walktheweb_searchbutton" /><div style='min-height:20px;clear:both;'></div>			
			</div>
			<div class="walktheweb_searchdiv">
			...
			<div class="walktheweb_searchdiv">
				<div class="walktheweb_colicons">
					<img id="walktheweb_community1" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/community2.png" alt="3D Communities" title="3D Communities" class="walktheweb_tinyimgselected" />
	...
	<script>
		window.onload = function() {
			walktheweb_d.search('', 'community');
		}
	</script>
<?php	
	} catch (Exception $e) {
		$WalkTheWeb->serror("wtw-pages-walktheweb_downloadcommunity.php = ".$e->getMessage());
	}
?>
