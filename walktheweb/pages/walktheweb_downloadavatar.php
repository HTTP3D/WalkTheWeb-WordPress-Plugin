...
?>
	<form id="walktheweb_form2" method="post" action="?nonce=<?php /* echo $znonce; */ ?>">
		...
		<input id='walktheweb_twebtype' name='walktheweb_twebtype' type='hidden' value='avatar' />
		<div class="wrap walktheweb_div" style="vertical-align:top;">
			...
			<div class="walktheweb_searchdiv">
				...
				<input name='walktheweb_bsearch' type='button' value='Search' onclick="walktheweb_d.search(document.getElementById('walktheweb_tsearch').value, 'avatar');" class="walktheweb_searchbutton" /><div style='min-height:20px;clear:both;'></div>			
			</div>
			<div class="walktheweb_searchdiv">
			...
			<div class="walktheweb_searchdiv">
				<div class="walktheweb_colicons">
					...
					<img id="walktheweb_thing1" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/thing.png" alt="3D Things" title="3D Things" class="walktheweb_tinyimg" onclick="window.location.href='<?php echo $zsiteurl; ?>/wp-admin/admin.php?page=walktheweb_downloadthing';" />
					<img id="walktheweb_avatar1" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/avatar2.png" alt="3D Avatars" title="3D Avatars" class="walktheweb_tinyimgselected" />
				</div>
			</div>
			<div style="clear:both;">
				...
				<div id="walktheweb_confirm" class="walktheweb_confirm" style="display:none;visibility:hidden;">
					<div id="walktheweb_previewdiv">
						...
						<input id='walktheweb_twebsite' name='walktheweb_twebsite' type='text' value='' size='50' maxlength='255' class="walktheweb_textboxwider" autocomplete="" value="https://3d.walktheweb.com" /><br /><br />
				...
				<div id="walktheweb_searchresults"></div>
	...
	<script>
		window.onload = function() {
			walktheweb_d.search('', 'avatar');
		}
	</script>
<?php	
	} catch (Exception $e) {
		$WalkTheWeb->serror("wtw-pages-walktheweb_downloadavatar.php = ".$e->getMessage());
	}
?>
